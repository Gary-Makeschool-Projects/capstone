!(function(n) {
    ...
    14: function(e, t, n) {
        ...
        t.a = {
            ...
            isChrome: function() {
                var e = window.chrome,
                    t = f().vendor,
                    n = -1 < f().userAgent.indexOf('OPR'),
                    r = -1 < f().userAgent.indexOf('Edge');
                return (!!f().userAgent.match('CriOS') ||
    ...
    947: function(e, t, n) {
        ...
        var a = n(304).public_path;

        function c() {
            return window[v] && window[v].booted;
        }
                ...
                (s(),
                    (function() {
                        ...
                        n.setAttribute(
                            ...
                            n.contentDocument.head.appendChild(Object(u.a)(w)),
                            n.contentDocument.head.appendChild(Object(u.a)(h));
                    })(),
                    (window[v].booted = !0));
        }
        var m,
            p,
            l,
            w = a + 'frame.b758ff42.js',
            h = a + 'vendor.9d9e1ba4.js',
            v = 'Intercom',
            g = /bot|googlebot|crawler|spider|robot|crawling|facebookexternalhit/i;
        ...
        (navigator && navigator.userAgent && g.test(navigator.userAgent)) ||
        window.isIntercomMessengerSheet ||
            ...
            (f(),
                ...
                (p = d),
                (l = function() {
                    window[v]('shutdown', !1), delete window[v], d(), s();
                }),
